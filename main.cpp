...
void printVector(vector<float> const &input)
{
...
int main(){
    ...
    */
    ...
    vector<float> listOfEmptyCases = vmyStorage.getEmptyCases();
    printVector(listOfEmptyCases); //vbag1 and vbag2 took the smallest and least recently empty cases 
